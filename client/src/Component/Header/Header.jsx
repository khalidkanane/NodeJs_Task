...
const Header = () => {
    ...
    return (
        <header class="antialiased shadow-lg m-3 rounded-lg bg-gray-100 border-2 border-blue-200">
                ...
                <div class="flex flex-wrap justify-between items-center">
                    <div class="flex justify-start items-center">
                        ...
                        <a href="https://flowbite.com" class="flex mr-4">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQOr5ovjMWUwcikyS9KgNdEw_cIhqju1owenw&s" class="mr-3 w-8 h-8" alt="FlowBite Logo" />
                            <span class="self-center text-2xl font-semibold whitespace-nowrap ">Task Track hub</span>
                        </a>
                    ...
                    <div class="flex items-center lg:order-2">
                        ...
                        <Dropdown label="Dropdown" dismissOnClick={false} renderTrigger={() =>       <img src="https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=634&q=80" alt="avatar of Jese" rounded className='h-6 w-6 object-cover rounded-full' />
}>
                            <Dropdown.Header>
                                <span className="block text-sm">Bonnie Green</span>
                                <span className="block truncate text-sm font-medium">bonnie@flowbite.com</span>
                            </Dropdown.Header>
                            <Dropdown.Item icon={HiViewGrid}>Tasks</Dropdown.Item>
